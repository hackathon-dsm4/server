...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Dictionary dictionary8 = Dictionary.builder()
                ...
                .type(DictionaryType.ECONOMY)
                .build();

        Dictionary dictionary9 = Dictionary.builder()
                .word("70억 법칙")
        ...
        Dictionary dictionary10 = Dictionary.builder()
        ...
        Dictionary dictionary22 = Dictionary.builder()
                .word("3D TV")
                ...
                .type(DictionaryType.SCIENCE)
                .build();

        Dictionary dictionary23 = Dictionary.builder()
                .word("3G/4G")
        ...
        Dictionary dictionary29 = Dictionary.builder()
                .word("1인 창조기업")
                .meaning("개인이 사장이면서 직원인 기업을 의미합니다. 즉, 자신이 가진 아이디어, 지식, 경험, 전문기술 등을 사업화하여 보다 창조적인 서비스를 제공하고 이윤을 창출하는 경우 1인 창조기업에 해당합니다.")
                .type(DictionaryType.MANAGEMENT)
                .build();

        Dictionary dictionary30 = Dictionary.builder()
                .word("4Ps")
        ...
        Dictionary dictionary31 = Dictionary.builder()
        ...
        Dictionary dictionary32 = Dictionary.builder()
        ...
        Dictionary dictionary33 = Dictionary.builder()
                .word("ALCO 패키지")
        ...
        Dictionary dictionary36 = Dictionary.builder()
                .word("2차 시장(Secondary Market)")
                .meaning("2차 시장은 처음 발행된 증권, 채권 등이 거래되는 발행시장과 구분되며, 이미 발행된 주식들의 거래가 이루어지는 유통시장을 뜻한다.")
                .type(DictionaryType.FINANCE)
                .build();

        Dictionary dictionary37 = Dictionary.builder()
                .word("5일선")
                .meaning("5일동안의 평균주가를 이어놓은 선을 의미한다")
                .type(DictionaryType.FINANCE)
                .build();

        Dictionary dictionary38 = Dictionary.builder()
        ...
        Dictionary dictionary41 = Dictionary.builder()
                .word("BIC")
        ...
        Dictionary dictionary42 = Dictionary.builder()
                .word("BIS(Bank for International Settlements)")
                .meaning("국제결제은행는 중앙은행간의 통화결제나 예금을 받아들이는 것 등을 업무로 하고 있는 은행이다.")
                .type(DictionaryType.FINANCE)
                .build();

        wordRepository.save(dictionary1);
        wordRepository.save(dictionary2);
        wordRepository.save(dictionary3);
        wordRepository.save(dictionary4);
        wordRepository.save(dictionary5);
        wordRepository.save(dictionary6);
        wordRepository.save(dictionary7);
        wordRepository.save(dictionary8);
        wordRepository.save(dictionary9);
        wordRepository.save(dictionary10);
        wordRepository.save(dictionary11);
        wordRepository.save(dictionary12);
        wordRepository.save(dictionary13);
        wordRepository.save(dictionary14);
        wordRepository.save(dictionary15);
        wordRepository.save(dictionary16);
        wordRepository.save(dictionary17);
        wordRepository.save(dictionary18);
        wordRepository.save(dictionary19);
        wordRepository.save(dictionary20);
        wordRepository.save(dictionary21);
        wordRepository.save(dictionary22);
        wordRepository.save(dictionary23);
        wordRepository.save(dictionary24);
        wordRepository.save(dictionary25);
        wordRepository.save(dictionary26);
        wordRepository.save(dictionary27);
        wordRepository.save(dictionary28);
        wordRepository.save(dictionary29);
        wordRepository.save(dictionary30);
        wordRepository.save(dictionary31);
        wordRepository.save(dictionary32);
        wordRepository.save(dictionary33);
        wordRepository.save(dictionary34);
        wordRepository.save(dictionary35);
        wordRepository.save(dictionary36);
        wordRepository.save(dictionary37);
        wordRepository.save(dictionary38);
        wordRepository.save(dictionary39);
        wordRepository.save(dictionary40);
        wordRepository.save(dictionary41);
        wordRepository.save(dictionary42);
    }
}
